from app.core.exceptions import FolderNotFoundException, NoteNotFoundException
...
class NoteService:
    ...
    async def get_all_notes(
        ...
        if folder_id is not None:
            await self.validate_folder(user_id=user_id, folder_id=folder_id)
    ...
    async def get_note_by_id(self, note_id: int, user_id: int) -> Note:
    ...
    async def validate_folder(
        ...
        folder = await self.folder_repository.get_by_id(
    ...
    async def update_note(
        ...
        note = await self.get_note_by_id(note_id=note_id, user_id=user_id)
